...
final class ItemStackSerializer implements ObjectSerializer<ItemStack> {
    ...
    public void serialize(@NonNull ItemStack itemStack, @NonNull SerializationData data) {
        ...
        if (itemStack.getDurability() != 0) {
            data.add("durability", itemStack.getType().getMaxDurability() - itemStack.getDurability());
        }
    ...
    public ItemStack deserialize(@NonNull DeserializationData data, @NonNull GenericsDeclaration generics) {
        ...
        itemStack.setDurability((short) (material.getMaxDurability() - durability));
